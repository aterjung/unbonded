...
pageMod.PageMod({
    ...
    contentScriptFile: [self.data.url("jquery-1.11.1.min.js"), self.data.url("jquery-ui.js"), self.data.url("aufgeld.js")],
    contentStyleFile: [self.data.url("style.css"),self.data.url("jquery-ui.css")],
